  ...
  return (<div className={tenant?'tenant':''}>
    ...
    <footer className="mt-16 bg-brown-900 text-brown-100">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 md:grid-cols-4">
        ...
        <div className="text-sm"><b className="text-white">For temples</b><br/><Link to="/submit-temple">Submit a temple</Link><br/><Link to="/login?next=/account/listings/new&intent=create-profile">Create a profile</Link><br/><Link to="/vendor">Temple login</Link><br/><Link to="/sponsor">Sponsor a temple</Link></div>
