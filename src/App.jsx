...
const routes = [
  ...
  ['/agent', X.AWallet], ['/agent/profile', X.AProfile], ['/agent/listings', X.AListings], ['/agent/listings/:slug/edit', X.AEditListing], ['/agent/share', X.AShare], ['/agent/submit', X.ASubmit], ['/agent/submissions', X.ASubmissions], ['/dealer', X.DDash], ['/dealer/agents', X.DAgents],
...
const groups = [
  ...
  ['Agent & dealer', ['/agent','/agent/profile','/agent/listings','/agent/listings/vengamala-bhagavathi-temple/edit','/agent/share','/agent/submit','/agent/submissions','/dealer','/dealer/agents']],
