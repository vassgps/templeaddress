...
const routes = [
  ...
  ['/partner', X.AWallet], ['/partner/profile', X.AProfile], ['/partner/listings', X.AListings], ['/partner/listings/:slug/edit', X.AEditListing], ['/partner/share', X.AShare], ['/partner/submit', X.ASubmit], ['/partner/submissions', X.ASubmissions], ['/dealer', X.DDash], ['/dealer/wallet', X.DWallet], ['/dealer/profile', X.DProfile], ['/dealer/partners', X.DPartners],
...
const groups = [
  ['Public / devotee', ['/','/temples','/submit-temple','/t/kottur-sree-mahavishnu-temple','/book/kottur-sree-mahavishnu-temple','/receipt','/donate/kottur-sree-mahavishnu-temple','/special','/special/sp1','/festival','/services','/service/sv1','/sponsor','/login','/account','/account/listings','/account/listings/new','/account/partner-application','/whatsapp']],
