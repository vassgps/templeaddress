...
const groups = [
  ...
  ['Staff · Accountant / admin', ['/staff?role=accountant','/staff/payouts?role=accountant','/staff/withdrawals?role=accountant','/staff?role=admin','/staff/wallet-credit?role=admin','/staff/config?role=admin','/staff/tables?role=admin']],
]
